...
class Config
{
    ...
    public function default(): array
    {
        ...
        $default = [
            ...
            "dir" => [
                "logs" => _DIR_LOGS_,
                "uploads" => _DIR_UPLOADS_ //la directory uploads è definita su system start ma viene chiamata con la funzione uploads() perchè può essere customizzata da questo parametro
            ],
            "upload" => [
        ...
        foreach(Folder::read(_DIR_FRAMEWORK_ . 'Elements') as $element) {

            if(file_exists(_DIR_FRAMEWORK_ . 'Elements/' . $element . '/Config.php')) {
                $default = array_replace_recursive($default,require_once(_DIR_FRAMEWORK_ . 'Elements/' . $element . '/Config.php'));
            }
